...
The repository contains `opennav_visual_nav_demo`, which comprises the application launch files, behavior trees, and autonomy script for a vision-based navigation application.
